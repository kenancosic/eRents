namespace eRents.Features.Shared.Exceptions;

/// <summary>
/// Exception thrown when concurrency conflicts are detected
/// Used across all Features for database conflict handling
/// </summary>
