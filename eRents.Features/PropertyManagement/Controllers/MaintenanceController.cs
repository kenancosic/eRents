...
/// Consolidated with PropertyManagement module
/// </summary>
[ApiController]
...
public class MaintenanceController : BaseController
{
        ...
        [FromQuery] DateTime? endDate = null)
    {
        try
        {
            var issues = await _propertyService.GetUserMaintenanceIssuesAsync(propertyId, status, priority, startDate, endDate);
            return Ok(issues);
        }
        catch (Exception ex)
        {
    ...
    public async Task<ActionResult<MaintenanceIssueResponse>> GetMaintenanceIssue(int id)
        => await this.GetByIdAsync<MaintenanceIssueResponse, int>(id, _propertyService.GetMaintenanceIssueByIdAsync, _logger);
    ...
    public async Task<ActionResult<IEnumerable<MaintenanceIssueResponse>>> GetPropertyMaintenanceIssues(int propertyId)
    {
        try
        {
            var issues = await _propertyService.GetPropertyMaintenanceIssuesAsync(propertyId);
            return Ok(issues);
        }
    ...
    public async Task<ActionResult<MaintenanceIssueResponse>> CreateMaintenanceIssue([FromBody] MaintenanceIssueRequest request)
        => await this.CreateAsync<MaintenanceIssueRequest, MaintenanceIssueResponse>(
            request,
            _propertyService.CreateMaintenanceIssueAsync,
            _logger,
    ...
    public async Task<ActionResult<MaintenanceIssueResponse>> UpdateMaintenanceIssue(int id, [FromBody] MaintenanceIssueRequest request)
        => await this.UpdateAsync<MaintenanceIssueRequest, MaintenanceIssueResponse>(id, request, _propertyService.UpdateMaintenanceIssueAsync, _logger);
    ...
    public async Task<IActionResult> UpdateMaintenanceStatus(int id, [FromBody] MaintenanceStatusUpdateRequest request)
        ...
        {
            await _propertyService.UpdateMaintenanceStatusAsync(id, request);
    ...
    public async Task<IActionResult> DeleteMaintenanceIssue(int id)
        => await this.DeleteAsync(id, _propertyService.DeleteMaintenanceIssueAsync, _logger);
    ...
    public async Task<ActionResult<MaintenanceStatisticsResponse>> GetMaintenanceStatistics()
        => await this.ExecuteAsync(async () => await _propertyService.GetMaintenanceStatisticsAsync(), _logger, "GetMaintenanceStatistics");
    ...
    public async Task<ActionResult<PropertyMaintenanceSummaryResponse>> GetPropertyMaintenanceSummary(int propertyId)
    {
        try
        {
            var summary = await _propertyService.GetPropertyMaintenanceSummaryAsync(propertyId);
            return Ok(summary);
        }
        catch (UnauthorizedAccessException)
        {
    ...
    public async Task<ActionResult<List<MaintenanceIssueResponse>>> GetOverdueMaintenanceIssues()
        => await this.ExecuteAsync(async () => await _propertyService.GetOverdueMaintenanceIssuesAsync(), _logger, "GetOverdueMaintenanceIssues");
    ...
    public async Task<ActionResult<IEnumerable<MaintenanceIssueResponse>>> GetRecentMaintenance([FromQuery] int days = 7)
    {
        try
        {
            var recentIssues = await _propertyService.GetUpcomingMaintenanceAsync(days);
    ...
    public async Task<IActionResult> AssignMaintenanceIssue(int issueId, [FromBody] AssignMaintenanceRequest request)
    {
        try
        {
            ...
            await _propertyService.AssignMaintenanceIssueAsync(issueId, request.AssignedToUserId);
    ...
    public async Task<ActionResult<IEnumerable<MaintenanceIssueResponse>>> GetAssignedMaintenanceIssues()
    {
        try
        {
            var assignedIssues = await _propertyService.GetAssignedMaintenanceIssuesAsync();
    ...
    public async Task<ActionResult<object>> GetMaintenanceDashboard()
    {
        try
        {
            var statistics = await _propertyService.GetMaintenanceStatisticsAsync();
            var overdueIssues = await _propertyService.GetOverdueMaintenanceIssuesAsync();
            var recentIssues = await _propertyService.GetUpcomingMaintenanceAsync(7);
        ...
        try
        {
            ...
            foreach (var issueId in request.IssueIds)
            {
                try
                {
                    ...
                    await _propertyService.UpdateMaintenanceStatusAsync(issueId, statusUpdate);
                    completedCount++;
                }
                catch
                {
