-- 1. SEED BASE/LOOKUP TABLES WITH NO FOREIGN KEYS FIRST
...
-- 2. SEED TABLES WITH FOREIGN KEYS TO THE BASE TABLES
...
-- 3. SEED TABLES WITH MORE COMPLEX FOREIGN KEY RELATIONSHIPS

-- Seed PropertyAmenities (many-to-many relationship)
...
-- Seed TenantPreferenceAmenities (many-to-many relationship)
INSERT INTO TenantPreferenceAmenity (TenantPreferenceId, AmenityId) VALUES
(1, 1), -- TenantPreferenceId 1 (Amer Hasić) prefers Wi-Fi (1)
(1, 3), -- TenantPreferenceId 1 (Amer Hasić) prefers Parking (3)
(2, 2), -- TenantPreferenceId 2 (Adnan Sarajlić) prefers Air Conditioning (2)
(2, 5), -- TenantPreferenceId 2 (Adnan Sarajlić) prefers Balcony (5)
(3, 1), -- TenantPreferenceId 3 (Marko Marić) prefers Wi-Fi (1)
(3, 2), -- TenantPreferenceId 3 (Marko Marić) prefers Air Conditioning (2)
(3, 4), -- TenantPreferenceId 3 (Marko Marić) prefers Heating (4)
(4, 1), -- TenantPreferenceId 4 (Tarik Hadžić) prefers Wi-Fi (1)
(4, 3); -- TenantPreferenceId 4 (Tarik Hadžić) prefers Parking (3)
GO

-- Seed UserSavedProperties (many-to-many relationship)
