	...
	public class SetupService
	{
		...
		private async Task SeedReferenceDataAsync(ERentsContext context)
		{
			...
			var geoRegions = new[]
			{
				...
				new GeoRegion { City = "Doboj", State = "Republika Srpska", Country = "Bosnia and Herzegovina", PostalCode = "74000" },
				new GeoRegion { City = "Cazin", State = "Federation of Bosnia and Herzegovina", Country = "Bosnia and Herzegovina", PostalCode = "77220" }
			};
		...
		private async Task SeedSampleDataAsync(ERentsContext context)
		{
			...
			var addressDetails = new[]
			{
				...
				new AddressDetail { GeoRegionId = dbGeoRegions[5].GeoRegionId, StreetLine1 = "Svetog Save 25", Latitude = 44.7594m, Longitude = 19.2094m },
				new AddressDetail { GeoRegionId = dbGeoRegions[6].GeoRegionId, StreetLine1 = "Ul. Jovana Ducića 12", Latitude = 44.9778m, Longitude = 16.1583m },
				new AddressDetail { GeoRegionId = dbGeoRegions[7].GeoRegionId, StreetLine1 = "Bulevar Mira 45", Latitude = 44.8694m, Longitude = 18.8111m },
				new AddressDetail { GeoRegionId = dbGeoRegions[8].GeoRegionId, StreetLine1 = "Kneza Miloša 8", Latitude = 44.7311m, Longitude = 18.0872m },
				new AddressDetail { GeoRegionId = dbGeoRegions[9].GeoRegionId, StreetLine1 = "Alije Izetbegovića 33", Latitude = 44.9667m, Longitude = 15.9500m }
			};
			...
			var users = new[]
			{
				...
				// Test users with Bosnian addresses
				new User { Username = "testLandlord", Email = "testLandlord@example.ba", PasswordHash = landlordHash, PasswordSalt = landlordSalt, PhoneNumber = "38761234567", DateOfBirth = new DateOnly(1985, 1, 1), UserTypeId = dbUserTypes.First(ut => ut.TypeName == "Landlord").UserTypeId, FirstName = "Marko", LastName = "Vlajić", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsPublic = true, AddressDetailId = dbAddressDetails[5].AddressDetailId },
				new User { Username = "testUser", Email = "testUser@example.ba", PasswordHash = tenantHash, PasswordSalt = tenantSalt, PhoneNumber = "38767654321", DateOfBirth = new DateOnly(1990, 6, 15), UserTypeId = dbUserTypes.First(ut => ut.TypeName == "Tenant").UserTypeId, FirstName = "Ana", LastName = "Petrović", CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now, IsPublic = true, AddressDetailId = dbAddressDetails[6].AddressDetailId },
				
				// Additional diverse users
				new User { Username = "marianovac", Email = "mario.novac@example.ba", PasswordHash = commonHash, PasswordSalt = commonSalt, PhoneNumber = "38761789789", DateOfBirth = new DateOnly(1987, 3, 12), UserTypeId = dbUserTypes.First(ut => ut.TypeName == "Tenant").UserTypeId, FirstName = "Mario", LastName = "Novac", CreatedAt = DateTime.Now.AddDays(-90), UpdatedAt = DateTime.Now, IsPublic = true, AddressDetailId = dbAddressDetails[7].AddressDetailId },
				new User { Username = "anamaric", Email = "ana.maric@example.ba", PasswordHash = commonHash, PasswordSalt = commonSalt, PhoneNumber = "38762234567", DateOfBirth = new DateOnly(1993, 7, 8), UserTypeId = dbUserTypes.First(ut => ut.TypeName == "Landlord").UserTypeId, FirstName = "Ana", LastName = "Marić", CreatedAt = DateTime.Now.AddDays(-120), UpdatedAt = DateTime.Now, IsPublic = true, AddressDetailId = dbAddressDetails[8].AddressDetailId },
				...
				new User { Username = "milicaZE", Email = "milica.zenica@example.ba", PasswordHash = commonHash, PasswordSalt = commonSalt, PhoneNumber = "38763456789", DateOfBirth = new DateOnly(1991, 2, 18), UserTypeId = dbUserTypes.First(ut => ut.TypeName == "Tenant").UserTypeId, FirstName = "Milica", LastName = "Zečević", CreatedAt = DateTime.Now.AddDays(-60), UpdatedAt = DateTime.Now, IsPublic = true, AddressDetailId = dbAddressDetails[9].AddressDetailId }
			};
			...
			var properties = new[]
			{
				// Existing properties with realistic BAM pricing
				new Property { Name = "Stan u Centru Sarajeva", Description = "Prostran stan na odličnoj lokaciji u Sarajevu.", Price = 750.00m, DailyRate = 35.00m, MinimumStayDays = 3, Currency = "BAM", Status = "Available", OwnerId = dbUsers.First(u => u.Username == "lejlazukic").UserId, DateAdded = DateTime.Now, PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "Apartment").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Long-term").RentingTypeId, AddressDetailId = dbAddressDetails[0].AddressDetailId, Bedrooms = 2, Bathrooms = 1, Area = 75.5m },
				new Property { Name = "Kuća s Pogledom u Banjaluci", Description = "Kuća sa prelijepim pogledom na grad.", Price = 1100.00m, DailyRate = 45.00m, MinimumStayDays = 7, Currency = "BAM", Status = "Rented", OwnerId = dbUsers.First(u => u.Username == "testLandlord").UserId, DateAdded = DateTime.Now, PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "House").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Long-term").RentingTypeId, AddressDetailId = dbAddressDetails[1].AddressDetailId, Bedrooms = 3, Bathrooms = 2, Area = 120.0m },
				new Property { Name = "Apartman Stari Most Mostar", Description = "Moderan apartman blizu Starog Mosta.", Price = 650.00m, DailyRate = 40.00m, MinimumStayDays = 2, Currency = "BAM", Status = "Available", OwnerId = dbUsers.First(u => u.Username == "ivanabL").UserId, DateAdded = DateTime.Now, PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "Apartment").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Short-term").RentingTypeId, AddressDetailId = dbAddressDetails[2].AddressDetailId, Bedrooms = 1, Bathrooms = 1, Area = 55.0m },
				new Property { Name = "Porodična Kuća Tuzla", Description = "Idealna kuća za porodicu u mirnom dijelu Tuzle.", Price = 950.00m, DailyRate = 50.00m, MinimumStayDays = 14, Currency = "BAM", Status = "Under Maintenance", OwnerId = dbUsers.First(u => u.Username == "ivanabL").UserId, DateAdded = DateTime.Now, PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "House").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Long-term").RentingTypeId, AddressDetailId = dbAddressDetails[3].AddressDetailId, Bedrooms = 4, Bathrooms = 2, Area = 150.0m },
				
				// New test properties with realistic pricing
				new Property { Name = "Moderni Stan Bijeljina", Description = "Savremeno opremljen stan u centru Bijeljine.", Price = 550.00m, DailyRate = 30.00m, MinimumStayDays = 3, Currency = "BAM", Status = "Available", OwnerId = dbUsers.First(u => u.Username == "testLandlord").UserId, DateAdded = DateTime.Now, PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "Apartment").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Daily").RentingTypeId, AddressDetailId = dbAddressDetails[5].AddressDetailId, Bedrooms = 2, Bathrooms = 1, Area = 85.0m },
				new Property { Name = "Vila Prijedor s Dvorištem", Description = "Prostrana kuća s velikim dvorištem, idealna za porodice.", Price = 1400.00m, DailyRate = 65.00m, MinimumStayDays = 30, Currency = "BAM", Status = "Available", OwnerId = dbUsers.First(u => u.Username == "testLandlord").UserId, DateAdded = DateTime.Now, PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "House").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Both").RentingTypeId, AddressDetailId = dbAddressDetails[6].AddressDetailId, Bedrooms = 3, Bathrooms = 2, Area = 140.0m },
				
				// Additional diverse properties
				new Property { Name = "Luksuzna Vila Zenica", Description = "Prelepa vila s bazenom i dvorištem, savršena za porodice.", Price = 1800.00m, DailyRate = 80.00m, MinimumStayDays = 7, Currency = "BAM", Status = "Available", OwnerId = dbUsers.First(u => u.Username == "lejlazukic").UserId, DateAdded = DateTime.Now.AddDays(-30), PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "Villa").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Both").RentingTypeId, AddressDetailId = dbAddressDetails[4].AddressDetailId, Bedrooms = 5, Bathrooms = 3, Area = 280.0m },
				new Property { Name = "Studio Centar Brčko", Description = "Kompaktan moderan studio u srcu grada.", Price = 400.00m, DailyRate = 25.00m, MinimumStayDays = 2, Currency = "BAM", Status = "Rented", OwnerId = dbUsers.First(u => u.Username == "ivanabL").UserId, DateAdded = DateTime.Now.AddDays(-15), PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "Studio").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Daily").RentingTypeId, AddressDetailId = dbAddressDetails[7].AddressDetailId, Bedrooms = 0, Bathrooms = 1, Area = 35.0m },
				new Property { Name = "Penthouse Sarajevo Novi Grad", Description = "Ekskluzivni penthouse s panoramskim pogledom na grad.", Price = 2000.00m, DailyRate = 120.00m, MinimumStayDays = 5, Currency = "BAM", Status = "Available", OwnerId = dbUsers.First(u => u.Username == "testLandlord").UserId, DateAdded = DateTime.Now.AddDays(-45), PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "Condo").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Vacation").RentingTypeId, AddressDetailId = dbAddressDetails[0].AddressDetailId, Bedrooms = 3, Bathrooms = 3, Area = 220.0m },
				new Property { Name = "Redovna Kuća Doboj", Description = "Udobna kuća u mirnom naselju s odličnim sadržajima.", Price = 800.00m, DailyRate = 45.00m, MinimumStayDays = 14, Currency = "BAM", Status = "Unavailable", OwnerId = dbUsers.First(u => u.Username == "anamaric").UserId, DateAdded = DateTime.Now.AddDays(-60), PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "Townhouse").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Monthly").RentingTypeId, AddressDetailId = dbAddressDetails[8].AddressDetailId, Bedrooms = 4, Bathrooms = 2, Area = 180.0m }
			};
			...
			var bookings = new[]
			{
				...
				// New active booking for testUser with testLandlord's property
				new Booking { PropertyId = dbProperties.First(p => p.Name == "Kuća s Pogledom u Banjaluci").PropertyId, UserId = dbUsers.First(u => u.Username == "testUser").UserId, StartDate = new DateOnly(2024, 12, 1), EndDate = new DateOnly(2025, 6, 1), TotalPrice = 7200.00m, BookingDate = DateOnly.FromDateTime(DateTime.Now.AddDays(-10)), BookingStatusId = dbBookingStatuses.First(bs => bs.StatusName == "Active").BookingStatusId }
			};
			...
			var tenants = new[]
			{
				...
				// New test tenant relationships - testUser renting from testLandlord
				new Tenant { UserId = dbUsers.First(u => u.Username == "testUser").UserId, PropertyId = dbProperties.First(p => p.Name == "Vila Prijedor s Dvorištem").PropertyId, LeaseStartDate = new DateOnly(2025, 2, 1), TenantStatus = "Pending" },
				new Tenant { UserId = dbUsers.First(u => u.Username == "testUser").UserId, PropertyId = dbProperties.First(p => p.Name == "Kuća s Pogledom u Banjaluci").PropertyId, LeaseStartDate = new DateOnly(2024, 6, 1), TenantStatus = "Active" }
			};
			...
			{
				new TenantPreference { UserId = dbUsers.First(u => u.Username == "testUser").UserId, SearchStartDate = DateTime.Now.AddDays(30), SearchEndDate = DateTime.Now.AddDays(90), MinPrice = 500m, MaxPrice = 1500m, City = "Sarajevo", Description = "Tražim moderan stan s dobrim saobraćajnim vezama", IsActive = true }
			};
			...
			var reviews = new[]
			{
				new Review { 
					...
					PropertyId = dbProperties.First(p => p.Name == "Moderni Stan Bijeljina").PropertyId, 
					BookingId = dbBookings.First(b => b.PropertyId == dbProperties.First(p => p.Name == "Moderni Stan Bijeljina").PropertyId).BookingId, 
					ReviewerId = dbBookings.First(b => b.PropertyId == dbProperties.First(p => p.Name == "Moderni Stan Bijeljina").PropertyId).UserId ?? 0,
					Description = "Odličan stan s izvrsnim sadržajima. Bih se ponovo vratio!", 
					StarRating = 4.8m, 
				...
				new Review { 
					...
					Description = "Lijepa lokacija, ali bi trebala neka osvježavanja", 
					StarRating = 3.5m, 
			...
			{
				new Notification { UserId = dbUsers.First(u => u.Username == "testUser").UserId, Title = "Booking Confirmed", Message = "Your booking for Vila Prijedor s Dvorištem has been confirmed", Type = "booking", ReferenceId = dbBookings.First(b => b.PropertyId == dbProperties.First(p => p.Name == "Vila Prijedor s Dvorištem").PropertyId).BookingId, IsRead = false },
				new Notification { UserId = dbUsers.First(u => u.Username == "testLandlord").UserId, Title = "New Maintenance Issue", Message = "A new maintenance issue has been reported for Vila Prijedor s Dvorištem", Type = "maintenance", ReferenceId = maintenanceIssues.First().MaintenanceIssueId, IsRead = false },
			...
			var payments = new[]
			{
				new Payment { TenantId = dbTenants.First(t => t.UserId == dbUsers.First(u => u.Username == "testUser").UserId && t.PropertyId == dbProperties.First(p => p.Name == "Vila Prijedor s Dvorištem").PropertyId).TenantId, PropertyId = dbProperties.First(p => p.Name == "Vila Prijedor s Dvorištem").PropertyId, Amount = 1400.00m, DatePaid = DateOnly.FromDateTime(DateTime.Now.AddDays(-15)), PaymentMethod = "Credit Card", PaymentStatus = "Completed", PaymentReference = "PAY-TEST-001" },
				
				// Payment for the new tenant relationship - testUser paying testLandlord for Kuća s Pogledom u Banjaluci
				new Payment { TenantId = dbTenants.First(t => t.UserId == dbUsers.First(u => u.Username == "testUser").UserId && t.PropertyId == dbProperties.First(p => p.Name == "Kuća s Pogledom u Banjaluci").PropertyId).TenantId, PropertyId = dbProperties.First(p => p.Name == "Kuća s Pogledom u Banjaluci").PropertyId, Amount = 1100.00m, DatePaid = DateOnly.FromDateTime(DateTime.Now.AddDays(-5)), PaymentMethod = "Bank Transfer", PaymentStatus = "Completed", PaymentReference = "PAY-TEST-002" }
			};
			...
			var apartmentInteriorData = LoadImageFromFile("SeedImages/Properties/apartment_interior.jpg");
			...
			var images = new[]
			{
				...
				// Second image for Stan u Centru Sarajeva
				new Image { PropertyId = dbProperties.First(p => p.Name == "Stan u Centru Sarajeva").PropertyId, ImageData = apartmentInteriorData, FileName = "apartment_interior.jpg", DateUploaded = DateTime.Now, IsCover = false, ContentType = "image/jpeg", Width = 1200, Height = 900, FileSizeBytes = apartmentInteriorData.Length, ThumbnailData = CreateThumbnail(apartmentInteriorData) },
				...
				// Additional images for Kuća s Pogledom u Banjaluci
				new Image { PropertyId = dbProperties.First(p => p.Name == "Kuća s Pogledom u Banjaluci").PropertyId, ImageData = house2Data, FileName = "house2_interior.jpg", DateUploaded = DateTime.Now, IsCover = false, ContentType = "image/jpeg", Width = 800, Height = 600, FileSizeBytes = house2Data.Length, ThumbnailData = CreateThumbnail(house2Data) },
				new Image { PropertyId = dbProperties.First(p => p.Name == "Kuća s Pogledom u Banjaluci").PropertyId, ImageData = villa1Data, FileName = "house_garden_view.jpg", DateUploaded = DateTime.Now, IsCover = false, ContentType = "image/jpeg", Width = 1200, Height = 900, FileSizeBytes = villa1Data.Length, ThumbnailData = CreateThumbnail(villa1Data) },
				...
				// Second image for Apartman Stari Most Mostar
				new Image { PropertyId = dbProperties.First(p => p.Name == "Apartman Stari Most Mostar").PropertyId, ImageData = cityApartmentData, FileName = "city_apartment_interior.jpg", DateUploaded = DateTime.Now, IsCover = false, ContentType = "image/jpeg", Width = 1200, Height = 800, FileSizeBytes = cityApartmentData.Length, ThumbnailData = CreateThumbnail(cityApartmentData) },
				...
				new Image { PropertyId = dbProperties.First(p => p.Name == "Test Daily Rental Apartment").PropertyId, ImageData = apartmentInteriorData, FileName = "apartment1_interior.jpg", DateUploaded = DateTime.Now, IsCover = false, ContentType = "image/jpeg", Width = 1200, Height = 900, FileSizeBytes = apartmentInteriorData.Length, ThumbnailData = CreateThumbnail(apartmentInteriorData) },
				...
				// Second image for Modern Studio Downtown
				new Image { PropertyId = dbProperties.First(p => p.Name == "Modern Studio Downtown").PropertyId, ImageData = apartmentInteriorData, FileName = "studio_living_space.jpg", DateUploaded = DateTime.Now.AddDays(-14), IsCover = false, ContentType = "image/jpeg", Width = 1200, Height = 900, FileSizeBytes = apartmentInteriorData.Length, ThumbnailData = CreateThumbnail(apartmentInteriorData) },
				...
				// Second image for Penthouse Manhattan Style
				new Image { PropertyId = dbProperties.First(p => p.Name == "Penthouse Manhattan Style").PropertyId, ImageData = cityApartmentData, FileName = "penthouse_city_view.jpg", DateUploaded = DateTime.Now.AddDays(-44), IsCover = false, ContentType = "image/jpeg", Width = 1200, Height = 800, FileSizeBytes = cityApartmentData.Length, ThumbnailData = CreateThumbnail(cityApartmentData) },
			...
			{
				new Property { Name = "Gradski Stan Centar", Description = "Moderan stan u centru grada.", Price = 900.00m, DailyRate = 45.00m, MinimumStayDays = 2, Currency = "BAM", Status = "Available", OwnerId = dbUsers.First(u => u.Username == "testLandlord").UserId, DateAdded = DateTime.Now.AddDays(-10), PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "Apartment").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Daily").RentingTypeId, AddressDetailId = dbAddressDetails[0].AddressDetailId, Bedrooms = 1, Bathrooms = 1, Area = 60.0m },
				new Property { Name = "Porodična Kuća Predgrađe", Description = "Prostrana kuća u mirnom predgrađu.", Price = 1300.00m, DailyRate = 60.00m, MinimumStayDays = 7, Currency = "BAM", Status = "Available", OwnerId = dbUsers.First(u => u.Username == "testLandlord").UserId, DateAdded = DateTime.Now.AddDays(-20), PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "House").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Both").RentingTypeId, AddressDetailId = dbAddressDetails[1].AddressDetailId, Bedrooms = 4, Bathrooms = 3, Area = 200.0m },
				new Property { Name = "Vila s Jezerom", Description = "Prekrasna kuća s pogledom na jezero.", Price = 1600.00m, DailyRate = 75.00m, MinimumStayDays = 5, Currency = "BAM", Status = "Available", OwnerId = dbUsers.First(u => u.Username == "testLandlord").UserId, DateAdded = DateTime.Now.AddDays(-30), PropertyTypeId = dbPropertyTypes.First(pt => pt.TypeName == "Villa").TypeId, RentingTypeId = dbRentingTypes.First(rt => rt.TypeName == "Vacation").RentingTypeId, AddressDetailId = dbAddressDetails[2].AddressDetailId, Bedrooms = 5, Bathrooms = 4, Area = 300.0m }
			};
			context.Properties.AddRange(moreProperties);
			await context.SaveChangesAsync();

			// Add images for the additional properties
			var moreImages = new[]
			{
				// City Loft Downtown (Apartment) - 2 images
				new Image { PropertyId = moreProperties.First(p => p.Name == "City Loft Downtown").PropertyId, ImageData = cityApartmentData, FileName = "city_loft_exterior.jpg", DateUploaded = DateTime.Now.AddDays(-8), IsCover = true, ContentType = "image/jpeg", Width = 1200, Height = 800, FileSizeBytes = cityApartmentData.Length, ThumbnailData = CreateThumbnail(cityApartmentData) },
				new Image { PropertyId = moreProperties.First(p => p.Name == "City Loft Downtown").PropertyId, ImageData = apartmentInteriorData, FileName = "city_loft_interior.jpg", DateUploaded = DateTime.Now.AddDays(-7), IsCover = false, ContentType = "image/jpeg", Width = 1200, Height = 900, FileSizeBytes = apartmentInteriorData.Length, ThumbnailData = CreateThumbnail(apartmentInteriorData) },
				
				// Suburban Family Home (House) - 2 images
				new Image { PropertyId = moreProperties.First(p => p.Name == "Suburban Family Home").PropertyId, ImageData = house2Data, FileName = "suburban_home_exterior.jpg", DateUploaded = DateTime.Now.AddDays(-18), IsCover = true, ContentType = "image/jpeg", Width = 800, Height = 600, FileSizeBytes = house2Data.Length, ThumbnailData = CreateThumbnail(house2Data) },
				new Image { PropertyId = moreProperties.First(p => p.Name == "Suburban Family Home").PropertyId, ImageData = house1Data, FileName = "suburban_home_interior.jpg", DateUploaded = DateTime.Now.AddDays(-17), IsCover = false, ContentType = "image/jpeg", Width = 800, Height = 600, FileSizeBytes = house1Data.Length, ThumbnailData = CreateThumbnail(house1Data) },
				
				// Lakeview Retreat (Villa) - 2 images
				new Image { PropertyId = moreProperties.First(p => p.Name == "Lakeview Retreat").PropertyId, ImageData = villa2Data, FileName = "lakeview_villa_exterior.jpg", DateUploaded = DateTime.Now.AddDays(-28), IsCover = true, ContentType = "image/jpeg", Width = 1000, Height = 750, FileSizeBytes = villa2Data.Length, ThumbnailData = CreateThumbnail(villa2Data) },
				new Image { PropertyId = moreProperties.First(p => p.Name == "Lakeview Retreat").PropertyId, ImageData = villa1Data, FileName = "lakeview_villa_lakeview.jpg", DateUploaded = DateTime.Now.AddDays(-27), IsCover = false, ContentType = "image/jpeg", Width = 1200, Height = 900, FileSizeBytes = villa1Data.Length, ThumbnailData = CreateThumbnail(villa1Data) }
			};
			context.Images.AddRange(moreImages);
			await context.SaveChangesAsync();
