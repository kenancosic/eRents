...
class BookingListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isUpcoming) {
      ...
      dateText =
          'Stayed: ${dateFormat.format(booking.startDate)} - ${booking.endDate != null ? dateFormat.format(booking.endDate!) : ''}';
      ...
      dateText =
          '${dateFormat.format(booking.startDate)} - ${booking.endDate != null ? dateFormat.format(booking.endDate!) : ''}';
    }
