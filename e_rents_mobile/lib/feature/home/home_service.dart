...
class HomeService {
  ...
  Future<List<Property>> fetchProperties({int page = 1}) async {
    final response =
        await apiService.get('/properties?page=$page', authenticated: true);
  ...
  Future<List<Property>> getPropertiesWithFilter(
    ...
    final response = await apiService.get('/properties/search$queryString',
        authenticated: true);
