...
namespace eRents.Domain.Migrations
{
    ...
    [Migration("20250605191421_ConvertToAddressValueObject_Properties")]
    partial class ConvertToAddressValueObject_Properties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eRents.Domain.Models.AddressDetail", b =>
                {
            ...
            modelBuilder.Entity("eRents.Domain.Models.GeoRegion", b =>
                {
                    b.Property<int>("GeoRegionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GeoRegionId"));
                    ...
                    b.HasIndex("City", "State", "Country", "PostalCode")
                        .IsUnique()
                        .HasFilter("[State] IS NOT NULL AND [PostalCode] IS NOT NULL");
            ...
            modelBuilder.Entity("eRents.Domain.Models.AddressDetail", b =>
                {
                    b.HasOne("eRents.Domain.Models.GeoRegion", "GeoRegion")
