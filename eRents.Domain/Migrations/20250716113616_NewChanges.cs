...
namespace eRents.Domain.Migrations
{
    ...
    public partial class NewChanges : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AmenityTenantPreference",
                columns: table => new
                {
                    AmenitiesAmenityId = table.Column<int>(type: "int", nullable: false),
                    TenantPreferencesTenantPreferenceId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmenityTenantPreference", x => new { x.AmenitiesAmenityId, x.TenantPreferencesTenantPreferenceId });
                    table.ForeignKey(
                        name: "FK_AmenityTenantPreference_Amenities_AmenitiesAmenityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "BookingStatusId", "StatusName" },
                values: new object[,]
                {
                    { 1, "Upcoming" },
                    { 2, "Completed" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmenityTenantPreference_TenantPreferencesTenantPreferenceId",
                table: "AmenityTenantPreference",
                column: "TenantPreferencesTenantPreferenceId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AmenityTenantPreference_TenantPreferences_TenantPreferencesTenantPreferenceId",
                table: "AmenityTenantPreference",
                column: "TenantPreferencesTenantPreferenceId",
                principalTable: "TenantPreferences",
                principalColumn: "TenantPreferenceId",
